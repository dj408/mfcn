...
The code in this repository reproduces the numerical convergence experiments, first presented in "Convergence of Manifold Filter-Combine Networks" (Johnson et al.), at the NeurIPS 2024 Symmetry and Geometry in Neural Representations workshop. To use this code:
